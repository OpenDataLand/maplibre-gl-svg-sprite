 ...
 * ```
 */
export abstract class BaseOp implements PostprocessOp {
 ...
 */
export function isOp(x: any): x is PostprocessOp {
 ...
 */
export function asPostprocess(op: PostprocessOp): Postprocess {
 ...
 * ```
 */
export function chain(...ops: Array<Postprocess | PostprocessOp>): Postprocess {
