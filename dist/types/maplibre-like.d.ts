...
export interface MapLibreLike {
    ...
    addProtocol: (name: string, handler: (request: {
        url: string;
    }, callback: (err?: any, response?: {
        data?: ArrayBuffer | string | object | null;
    }) => void) => any) => void;
...
export interface MapLike {
    ...
    on: (type: string, handler: (e: {
        id: string;
    }) => void) => void;
    /** Remove an event listener */
    off: (type: string, handler: (e: {
        id: string;
    }) => void) => void;
    /** Add an image to the map's style */
    addImage: (name: string, image: any, options?: {
        pixelRatio?: number;
    }) => void;
    /** Update an existing image in the map's style */
    updateImage?: (name: string, image: any, options?: {
        pixelRatio?: number;
    }) => void;
